...
public class NewsFeedController extends BaseController{
    ...
    private ResponseEntity<?> getNewsFeedController(@RequestParam(defaultValue = "1") int page,
        ...
        return buildResponse("Get News Feed successfully", postServicePort.getNewsFeed(page, pageSize, sortBy, Long.parseLong(user.getUsername())).map(PostMapper.INSTANCE::postDomainToPostResponse));
    }
}
